...
public class SteamVR_Camera : MonoBehaviour
{
	...
	public void Expand()
	{
		...
		if (_origin == null)
		{
			_origin = new UnityEngine.GameObject(name + originSuffix).transform;
		...
		if (head == null)
		{
            _head = new UnityEngine.GameObject(name + headSuffix, typeof(SteamVR_TrackedObject)).transform;
			head.parent = _origin;
		...
		if (transform.parent != head)
		{
			...
			if (audioListener != null)
			{
                ...
                _ears = new UnityEngine.GameObject(name + earsSuffix, typeof(SteamVR_Ears)).transform;
				ears.parent = _head;
