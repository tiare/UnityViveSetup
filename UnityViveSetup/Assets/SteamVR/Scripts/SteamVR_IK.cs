...
public class SteamVR_IK : MonoBehaviour
{
	...
	void LateUpdate()
	{
		...
		if (startXform == null)
		{
            startXform = new UnityEngine.GameObject("startXform").transform;
		...
		if (jointXform == null)
		{
            jointXform = new UnityEngine.GameObject("jointXform").transform;
		...
		if (endXform == null)
		{
            endXform = new UnityEngine.GameObject("endXform").transform;
