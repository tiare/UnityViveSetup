...
public static class SteamVR_Utils
{
	...
	public static void TakeStereoScreenshot(uint screenshotHandle, UnityEngine.GameObject target, int cellSize, float ipd, ref string previewFilename, ref string VRFilename)
	{
		...
		{
			if (tempCamera == null)
				tempCamera = new UnityEngine.GameObject().AddComponent<Camera>();
			camera = tempCamera;
		}
