...
public class SteamVR_Render : MonoBehaviour
{
	...
	static public SteamVR_Render instance
	{
		get
		{
			if (_instance == null)
			{
                _instance = UnityEngine.GameObject.FindObjectOfType<SteamVR_Render>();

				if (_instance == null)
                    _instance = new UnityEngine.GameObject("[SteamVR]").AddComponent<SteamVR_Render>();
			}
			return _instance;
		}
	}
	...
	private void OnRequestScreenshot(VREvent_t vrEvent)
	{
		...
		if (screenshotType == EVRScreenshotType.StereoPanorama)
		{
            ...
            UnityEngine.GameObject screenshotPosition = new UnityEngine.GameObject("screenshotPosition");
	...
	void Awake()
	{
		...
		{
			var prefab = Resources.Load<UnityEngine.GameObject>("SteamVR_ExternalCamera");
