...
namespace Valve.VR.InteractionSystem
{
	...
	public static class Util
	{
		...
		//-------------------------------------------------
		public static T FindOrAddComponent<T>(UnityEngine.GameObject gameObject ) where T : Component
		{
		...
		//-------------------------------------------------
		public static void AfterTimer(UnityEngine.GameObject go, float _time, System.Action callback, bool trigger_if_destroyed_early = false )
		{
		...
		//-------------------------------------------------
		public static void IgnoreCollisions(UnityEngine.GameObject goA, UnityEngine.GameObject goB )
		{
		...
		//-------------------------------------------------
		public static void SetActive(UnityEngine.GameObject gameObject, bool active )
		{
			if ( gameObject != null )
			{
