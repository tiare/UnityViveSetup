...
namespace Valve.VR.InteractionSystem
{
	...
	public class InputModule : BaseInputModule
	{
		...
		public static InputModule instance
		{
			...
			{
				if ( _instance == null )
                    _instance = UnityEngine.GameObject.FindObjectOfType<InputModule>();
		...
		//-------------------------------------------------
		public void HoverBegin(UnityEngine.GameObject gameObject )
		{
		...
		//-------------------------------------------------
		public void HoverEnd(UnityEngine.GameObject gameObject )
		{
			PointerEventData pointerEventData = new PointerEventData( eventSystem );
		...
		//-------------------------------------------------
		public void Submit(UnityEngine.GameObject gameObject )
		{
