...
namespace Valve.VR.InteractionSystem
{
	...
	public class Hand : MonoBehaviour
	{
		...
		private UnityEngine.GameObject controllerObject = null;
		...
		void Awake()
		{
            ...
            applicationLostFocusObject = new UnityEngine.GameObject( "_application_lost_focus" );
		...
		private void UpdateDebugText()
		{
			if ( showDebugText )
			{
				if ( debugText == null )
				{
                    debugText = new UnityEngine.GameObject( "_debug_text" ).AddComponent<TextMesh>();
		...
		private void InitController( int index )
		{
			if ( controller == null )
			{
                ...
                controllerObject = UnityEngine.GameObject.Instantiate(controllerPrefab);
