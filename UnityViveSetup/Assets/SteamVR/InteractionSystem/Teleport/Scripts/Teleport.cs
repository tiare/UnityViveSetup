	...
	public class Teleport : MonoBehaviour
	{
		...
		public static Teleport instance
		{
			get
			{
				if ( _instance == null )
				{
                    _instance = UnityEngine.GameObject.FindObjectOfType<Teleport>();
				}
		...
		void Start()
		{
            teleportMarkers = UnityEngine.GameObject.FindObjectsOfType<TeleportMarkerBase>();
		...
		private void OnChaperoneInfoInitialized()
		{
			...
			if ( chaperone.initialized && chaperone.roomscale )
			{
				...
				if ( playAreaPreviewTransform == null )
				{
                    playAreaPreviewTransform = new UnityEngine.GameObject( "PlayAreaPreviewTransform" ).transform;
