...
namespace Valve.VR.InteractionSystem
{
	...
	public class TeleportArc : MonoBehaviour
	{
		...
		private void CreateLineRendererObjects()
		{
            ...
            UnityEngine.GameObject arcObjectsParent = new UnityEngine.GameObject( "ArcObjects" );
			...
			{
                UnityEngine.GameObject newObject = new UnityEngine.GameObject( "LineRenderer_" + i );
