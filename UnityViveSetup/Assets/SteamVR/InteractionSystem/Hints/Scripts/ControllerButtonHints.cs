...
namespace Valve.VR.InteractionSystem
{
	...
	public class ControllerButtonHints : MonoBehaviour
	{
		...
		private void OnHandInitialized( int deviceIndex )
		{
            ...
            renderModel = new UnityEngine.GameObject( "SteamVR_RenderModel" ).AddComponent<SteamVR_RenderModel>();
		...
		void OnRenderModelLoaded( SteamVR_RenderModel renderModel, bool succeess )
		{
			...
			{
                textHintParent = new UnityEngine.GameObject( "Text Hints" ).transform;
		...
		private void CreateAndAddButtonInfo( EVRButtonId buttonID )
		{
			...
			hintInfo.textHintObject = UnityEngine.GameObject.Instantiate(textHintPrefab, hintStartPos, Quaternion.identity) as UnityEngine.GameObject;
