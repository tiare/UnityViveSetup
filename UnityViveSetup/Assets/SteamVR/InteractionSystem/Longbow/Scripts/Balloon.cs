...
namespace Valve.VR.InteractionSystem
{
	...
	public class Balloon : MonoBehaviour
	{
		...
		//-------------------------------------------------
		private void SpawnParticles(UnityEngine.GameObject particlePrefab, SoundPlayOneshot sound )
		{
			// Don't do this twice
			...
			{
                UnityEngine.GameObject particleObject = Instantiate(particlePrefab, transform.position, transform.rotation) as UnityEngine.GameObject;
