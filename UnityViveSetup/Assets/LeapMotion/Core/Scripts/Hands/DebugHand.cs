...
namespace Leap.Unity
{
    ...
    {
        private Hand hand_;
        protected Vector3 handPositionOffset, elbowPosition; //Added by Tiare
        ...
        */
        protected void DrawDebugLines()
        {
            ...
            Vector3 palmPos = GetPosition();
            Vector3 elbowPos = hand.Arm.ElbowPosition.ToVector3() + handPositionOffset;
            Vector3 wristPos = hand.Arm.WristPosition.ToVector3() + handPositionOffset;

            Debug.DrawLine(elbowPos, wristPos, Color.red); //Arm
            Debug.DrawLine(wristPos, palmPos, Color.white); //Wrist to palm line
            Debug.DrawLine(palmPos, (palmPos + hand.PalmNormal.ToVector3() * hand.PalmWidth / 2), Color.black); //Hand Normal
            ...
            { //Fingers
                ...
                for (int i = 0; i < 4; ++i)
                {
                    ...
                    Vector3 prevJoint = bone.PrevJoint.ToVector3() + handPositionOffset;
                    Debug.DrawLine(prevJoint, prevJoint + bone.Direction.ToVector3() * bone.Length, colors[i]);
        ...
        {
            Vector3 origin = position.ToVector3() + handPositionOffset;
        ...
        public override void UpdateHandOffset(Vector3 positionOffset, Vector3 armLookAtPos, Vector3 shiftAxis, float shiftAngle) //added by Tiare
        {
            ...
            elbowPosition = armLookAtPos; //not used in this class!
            //shiftAngle not used in this class!
            //Vector3 shiftAxis not used in this class!
        }

        public override Vector3 GetPosition() //added by Tiare
        {
            Vector3 new_pos = GetLeapHand().PalmPosition.ToVector3(); //Edit by Tiare
