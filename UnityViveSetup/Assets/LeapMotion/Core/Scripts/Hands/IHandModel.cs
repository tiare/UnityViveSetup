...
namespace Leap.Unity
{
    ...
    public abstract class IHandModel : MonoBehaviour
    {
        ...
        public abstract void UpdateHandOffset(Vector3 positionOffset, Vector3 armLookAtPosition, Vector3 shiftAxis, float shiftAngle);//public abstract void UpdateHandOffset(Vector3 positionOffset, Quaternion rotationOffset); //added by Tiare
        public abstract Vector3 GetPosition(); //added by Tiare
        public abstract void FreezeFingers(bool rightHand); //added by Tiare
