    ...
    */
    public abstract class HandModel : IHandModel
    {
        ...
        */
        ...
        protected Vector3 handPositionOffset = Vector3.zero, elbowPosition = Vector3.zero, shiftRotationAxis = Vector3.zero; //Added by Tiare
        protected float shiftAngle = 0; //Added by Tiare
        protected bool freezeFingers = false;
        ...
        */
        ...
        {
            Vector3 local_position = hand_.PalmPosition.ToVector3(); //Edit by Tiare
            local_position += handPositionOffset; //Edit by Tiare
        ...
        */
        public Vector3 GetArmCenter()
        {
            if (hand_ != null)
            {
                ...
                return leap_center.ToVector3() + handPositionOffset; //edit by tiare
            }
            if (forearm)
            {
                //return forearm.position;
                return forearm.position + handPositionOffset;  //edit by tiare
            }
            return Vector3.zero;
        }
        ...
        */
        public Vector3 GetElbowPosition()
        {
            ...
            if (elbowJoint)
            {
                ...
                return elbowJoint.position + handPositionOffset; //Edit by Tiare
            }
            return Vector3.zero;
        }
        ...
        */
        public Vector3 GetWristPosition()
        {
            ...
            if (wristJoint)
            {
                ...
                return wristJoint.position + handPositionOffset; //Edit by Tiare
            }
            return Vector3.zero;
        }
        ...
        */
        public Quaternion GetArmRotation()
        {
            if (hand_ != null)
            {
                ...
                {
                    //Debug.Log("Messing with rotation 2: "+elbowPosition.ToString());
                    return Quaternion.LookRotation(GetWristPosition() - elbowPosition, hand_.Arm.Basis.yBasis.ToVector3()); //Edit Tiare
                }
        ...
        */
        ...
        public override void UpdateHandOffset(Vector3 positionOffset, Vector3 armLookAtPos, Vector3 axis, float angle) //added by Tiare
        {
            handPositionOffset = positionOffset;
            elbowPosition = armLookAtPos;
            shiftRotationAxis = axis;
            shiftAngle = angle;
            ...
            for (int i = 0; i < fingers.Length; ++i)
            {
                if (fingers[i] != null)
                {
                    fingers[i].SetHandPositionAndRotationOffset(positionOffset, axis, angle);
                }
            }
        }

        public float GetHandShiftAngle()
        {
            return shiftAngle;
        }

        public Vector3 GetHandShiftAxis()
        {
            return shiftRotationAxis;
        }
        ...
        public override void FreezeFingers(bool freeze)  //added by Tiare
        {
            freezeFingers = freeze;
        }
    }
}
