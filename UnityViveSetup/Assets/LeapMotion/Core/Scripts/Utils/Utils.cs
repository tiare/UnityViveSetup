...
namespace Leap.Unity {
  ...
  public static class Utils {
    ...
    public static void IgnoreCollisions(UnityEngine.GameObject first, UnityEngine.GameObject second, bool ignore = true) {
    ...
    /// object are ignored.
    /// </summary>
    public static void FindColliders<T>(UnityEngine.GameObject obj, List<T> colliders) where T : Collider {
      colliders.Clear();
