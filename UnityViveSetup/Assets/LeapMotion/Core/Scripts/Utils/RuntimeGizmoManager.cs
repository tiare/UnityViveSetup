...
namespace Leap.Unity.RuntimeGizmos {
  ...
  public class RuntimeGizmoManager : MonoBehaviour {
    ...
    /// The gizmo color will be set to white.
    /// </summary>
    public static bool TryGetGizmoDrawer(UnityEngine.GameObject attatchedGameObject, out RuntimeGizmoDrawer drawer) {
      drawer = _backDrawer;
    ...
    protected virtual void OnValidate() {
      ...
      if (_sphereMesh == null) {
                UnityEngine.GameObject tempSphere = UnityEngine.GameObject.CreatePrimitive(PrimitiveType.Sphere);
    ...
    private List<UnityEngine.GameObject> _objList = new List<UnityEngine.GameObject>();
    ...
    protected virtual void Update() {
      ...
      for (int i = 0; i < _objList.Count; i++) {
                UnityEngine.GameObject obj = _objList[i];
  ...
  public class RuntimeGizmoDrawer {
    ...
    public void DrawColliders(UnityEngine.GameObject gameObject, bool useWireframe = true,
